...
#include "ModeISurfingBC.h"
#include <math.h>

registerMooseObject("raccoonApp", ModeISurfingBC);

template <>
InputParameters
validParams<ModeISurfingBC>()
{
...
ModeISurfingBC::ModeISurfingBC(const InputParameters & parameters)
