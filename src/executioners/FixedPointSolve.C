...
//
//     _console << COLOR_BLUE << "--------------"
//              << "Fixed Point Iteration " << _fp_it << "--------------" << COLOR_DEFAULT << '\n';
//
...
//         _console << COLOR_BLUE << std::setw(2) << _fp_it << " Fixed Point |R| = " <<
//         COLOR_DEFAULT
//                  << Console::outputNorm(_fp_norm[_fp_it - 1], _fp_norm[_fp_it]) << '\n';
//       }
//
