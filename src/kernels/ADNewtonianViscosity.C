...
registerMooseObject("TensorMechanicsApp", ADNewtonianViscosity);
...
ADNewtonianViscosity::validParams()
{
  ...
  params.addParam<MaterialPropertyName>(
      "viscosity_name", "viscosity", "Name of the viscosity material");
...
ADReal
ADNewtonianViscosity::computeQpResidual()
{
  ...
  return _eta[_qp] * _grad_test[_i][_qp] * D.row(_component);
}
