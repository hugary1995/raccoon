...
#include "CNHDegradedElasticPlasticPK1Stress_NoSplit.h"

registerADMooseObject("raccoonApp", CNHDegradedElasticPlasticPK1Stress_NoSplit);

defineADLegacyParams(CNHDegradedElasticPlasticPK1Stress_NoSplit);

template <ComputeStage compute_stage>
InputParameters
CNHDegradedElasticPlasticPK1Stress_NoSplit<compute_stage>::validParams()
{
...
template <ComputeStage compute_stage>
CNHDegradedElasticPlasticPK1Stress_NoSplit<compute_stage>::CNHDegradedElasticPlasticPK1Stress_NoSplit(
...
template <ComputeStage compute_stage>
void
CNHDegradedElasticPlasticPK1Stress_NoSplit<compute_stage>::initQpStatefulProperties()
{
  _be_bar[_qp].zero();
...
template <ComputeStage compute_stage>
void
CNHDegradedElasticPlasticPK1Stress_NoSplit<compute_stage>::computeQpStress()
{
