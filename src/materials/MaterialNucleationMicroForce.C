...
MaterialNucleationMicroForce::computeQpProperties()
{
  ...
  // "<<K.value()<<std::endl;
  // std::cout<<"--------------------------------------------------------------------------gamma0
  // "<<gamma_0.value()<<std::endl;
  // std::cout<<"--------------------------------------------------------------------------gamma1
  // "<<gamma_1.value()<<std::endl;
  // std::cout<<"--------------------------------------------------------------------------gamma2
  // "<<gamma_2.value()<<std::endl;
  // std::cout<<"-------------------------------------------------------------------------------M
  // "<<M.value()<<std::endl;
  ...
  // "<<J2.value()<<std::endl;
  // std::cout<<"--------------------------------------------------------------------------sqrtJ2
  // "<<std::sqrt(J2)<<std::endl; Compute the external driving force required to recover the desired
  // strength envelope.
  ...
  // std::cout<<"---------------------------------------------------------------------------beta0
  // "<<beta_0.value()<<std::endl;
  // std::cout<<"---------------------------------------------------------------------------beta1
  // "<<beta_1.value()<<std::endl;
  // std::cout<<"---------------------------------------------------------------------------beta2
  // "<<beta_2.value()<<std::endl;
  // std::cout<<"---------------------------------------------------------------------------beta3
  // "<<beta_3.value()<<std::endl;
  // std::cout<<"------------------------------------------------------------------------------ce
  // "<<_ex_driving[_qp]<<std::endl;
}
