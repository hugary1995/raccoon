#include "ComputeDegradedStress.h"

registerMooseObject("raccoonApp", ComputeDegradedStress);

template <>
InputParameters
validParams<ComputeDegradedStress>()
{
...
ComputeDegradedStress::ComputeDegradedStress(const InputParameters & parameters)
...
void
ComputeDegradedStress::initQpStatefulProperties()
{
...
void
ComputeDegradedStress::computeQpStress()
{
