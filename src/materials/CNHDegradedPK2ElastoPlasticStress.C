...
#include "CNHDegradedPK2ElastoPlasticStress.h"

registerADMooseObject("raccoonApp", CNHDegradedPK2ElastoPlasticStress);

defineADValidParams(
    CNHDegradedPK2ElastoPlasticStress,
...
CNHDegradedPK2ElastoPlasticStress<compute_stage>::CNHDegradedPK2ElastoPlasticStress(
...
template <ComputeStage compute_stage>
void
CNHDegradedPK2ElastoPlasticStress<compute_stage>::initQpStatefulProperties()
{
...
template <ComputeStage compute_stage>
void
CNHDegradedPK2ElastoPlasticStress<compute_stage>::computeQpStress()
{
