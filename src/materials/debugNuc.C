...
registerADMooseObject("raccoonApp", debugNuc);

InputParameters
debugNuc::validParams()
{
...
debugNuc::debugNuc(const InputParameters & parameters)
  : Material(parameters),
...
debugNuc::computeQpProperties()
{
  ...
  mooseAssert(1 + beta_3 * I1 * I1 > 0, "1 + beta_3 * I1 * I1<=0");
