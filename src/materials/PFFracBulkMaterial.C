#include "PFFracBulkMaterial.h"

registerMooseObject("raccoonApp", PFFracBulkMaterial);

template <>
InputParameters
validParams<PFFracBulkMaterial>()
{
...
PFFracBulkMaterial::PFFracBulkMaterial(const InputParameters & parameters)
  : Material(parameters),
    _Gc(getFunction("Gc")),
    _L(getFunction("L")),
...
void
PFFracBulkMaterial::computeQpProperties()
{
