...
registerADMooseObject("raccoonApp", DeformationGradient);
...
void
DeformationGradient::initialSetup()
{
...
void
DeformationGradient::displacementIntegrityCheck()
{
...
ADReal
DeformationGradient::computeQpOutOfPlaneGradDisp()
{
