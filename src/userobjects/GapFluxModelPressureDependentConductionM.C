...
#include "GapFluxModelPressureDependentConductionM.h"

registerMooseObject("raccoonApp", GapFluxModelPressureDependentConductionM);

InputParameters
GapFluxModelPressureDependentConductionM::validParams()
{
...
GapFluxModelPressureDependentConductionM::GapFluxModelPressureDependentConductionM(
  ...
  : GapFluxModelBase(parameters),
    ...
    _min_conductivity(getADMaterialProperty<Real>("min_conductivity")),
    _max_conductivity(getADMaterialProperty<Real>("max_conductivity"))
{
}

ADReal
GapFluxModelPressureDependentConductionM::computeFlux() const
{
