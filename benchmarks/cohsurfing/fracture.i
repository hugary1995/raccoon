...
[Materials]
  ...
  [degradation]
    ...
    f_name = g
    function = (1-d)^2/((1-d)^2+Gc/c0/l/psic*d*(1+p*d)) #(1-d)^p*(1-eta)+eta
    phase_field = d
    parameter_names = 'p psic' #p eta
    parameter_values = '1 0.10' #2 0
...
[Outputs]
  ...
  # []
  exodus = true
  file_base = surf_coh_psic0.10_Gc2L0.35_dt1e-2_J5b_frac
  append_date = true
