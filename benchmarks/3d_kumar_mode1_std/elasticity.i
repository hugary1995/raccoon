...
[Mesh]
  ...
  [left_bottom_stitch]
    type = BoundingBoxNodeSetGenerator
    input = bottom_half
    new_boundary = left_bottom_stitch
    bottom_left = '-100 0 0'
    top_right = '20 0 0'
  []
  [right_bottom_stitch]
    type = BoundingBoxNodeSetGenerator
    input = bottom_half
    new_boundary = right_bottom_stitch
    bottom_left = '20 0 0'
    top_right = '100 0 0'
  []
  [left_stitch]
    type = StitchedMeshGenerator
    inputs = 'left_top_stitch left_bottom_stitch'
    stitch_boundaries_pairs = 'left_top_stitch left_bottom_stitch'
  []
  [right_stitch]
    type = StitchedMeshGenerator
...
[Outputs]
  [csv_]
type = CSV
file_base = 2d_kumar_mode1_std_ela
append_date = true
#show = 'var_u'
execute_vector_postprocessors_on = final
[]
  exodus = true
  file_base = 2d_kumar_mode1_std
  append_date = true
