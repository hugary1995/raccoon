E = 5.05e3 #5.05GPa #9.8e3 9.8Gpa
nu = 0.40
K = '${fparse E/3/(1-2*nu)}'
G = '${fparse E/2/(1+nu)}'
Lambda = '${fparse E*nu/(1+nu)/(1-2*nu)}'

Gc = 4.8e-1 #9.1e-2 91N/m
l = 0.05
sigma_ts = 128
sigma_cs = 256
delta = 0.5
...
# []
  exodus = true
  file_base = corner_refine5_Gc1_t1.2dt5e-2_ela
  append_date = true
