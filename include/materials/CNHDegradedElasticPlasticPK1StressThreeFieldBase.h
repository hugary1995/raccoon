...
class CNHDegradedElasticPlasticPK1StressThreeFieldBase : public ADDegradedElasticStressBase
{
public:
  static InputParameters validParams();

  CNHDegradedElasticPlasticPK1StressThreeFieldBase(const InputParameters & parameters);
