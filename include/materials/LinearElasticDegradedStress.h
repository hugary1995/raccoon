#ifndef LinearElasticDegradedStress_H
#define LinearElasticDegradedStress_H

#include "DecompositionWarehouse.h"

// Forward Declarations
class LinearElasticDegradedStress;

template <>
InputParameters validParams<LinearElasticDegradedStress>();

class LinearElasticDegradedStress : public DecompositionWarehouse
{
public:
  LinearElasticDegradedStress(const InputParameters & parameters);
...
#endif // LinearElasticDegradedStress_H
