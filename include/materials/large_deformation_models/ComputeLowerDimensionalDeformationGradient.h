 ...
 */
class ComputeLowerDimensionalDeformationGradient : public Material, public BaseNameInterface
{
public:
  static InputParameters validParams();

  ComputeLowerDimensionalDeformationGradient(const InputParameters & parameters);
...
protected:
  ...
  virtual RealVectorValue getNormal() const;
