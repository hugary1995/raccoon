 ...
 */
class GapFluxModelPressureDependentConductionM : public GapFluxModelBase
{
public:
  static InputParameters validParams();

  GapFluxModelPressureDependentConductionM(const InputParameters & parameters);
...
protected:
  ...
  const ADMaterialProperty<Real> & _min_conductivity;
  const ADMaterialProperty<Real> & _max_conductivity;
};
