...
# geometry
h = 1.0
Ls = [pow(10.0,0.3),pow(10.0,0.4),pow(10.0,0.5),pow(10.0,0.6),pow(10.0,0.7),pow(10.0,0.8),pow(10.0,0.9),pow(10.0,1.0)]
...
for L in Ls:
    ...
    os.system("mpiexec -n 12 raccoon-opt -i master.i")
